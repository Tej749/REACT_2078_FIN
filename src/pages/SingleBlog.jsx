    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row -mx-4">
            ...
            <div className="md:flex-1 px-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">{blog.course}</h2>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">{blog.mentor}</h2>
